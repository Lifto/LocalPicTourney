...
MODE = 'load-test'  # dev, prod, unit-test, load-test.
...
URL = 'localpictourney-api-load-test.vvj2gzuy6m.us-west-2.elasticbeanstalk.com'
SHARE_URL = 'localpictourney-api-load-test.vvj2gzuy6m.us-west-2.elasticbeanstalk.com'
...
# LOCATION_DB_HOST ='localpictourneylocationdev.cocmaif1j3d7.us-west-2.rds.amazonaws.com' -- set in env by terraform
