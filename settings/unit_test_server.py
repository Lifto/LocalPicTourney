...
MODE = 'unit-test'  # dev, prod, unit-test, load-test.
...
SQS_ENABLED = False
SQS_QUEUE_NAME = 'awseb-e-12345-stack-AWSEBWorkerQueue-RQFHFUUTR84F'

SNS_ENABLED = False
SNS_APPLICATION_ARN = 'arn:aws:sns:us-west-2:12345:app/APNS_SANDBOX/LocalPicTourney-APNS-dev'

KINESIS_ENABLED = False
SCORE_STREAM = "{}-{}-score-stream".format(NAME, MODE)
TAG_TREND_STREAM = "{}-{}-tag-trend-stream".format(NAME, MODE)

LOCATION_DB_ENABLED = False
LOCATION_DB_NAME ='loc'
LOCATION_DB_USER ='awsuser'
LOCATION_DB_PASSWORD ='secretpassword'
LOCATION_DB_HOST ='localpictourneylocationdev.12345.us-west-2.rds.amazonaws.com'
